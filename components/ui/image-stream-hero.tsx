...
export type CorridorPath = {
  ...
  cardHeight?: number;
  /** Corner radius applied to each card. @default 2.0 */
  cardRadius?: number;
...
const PATH: Required<CorridorPath> = {
  ...
  cardWidth: 18,
  cardHeight: 25,
  cardRadius: 2.0, // Increased corner curve for a modern elegant curved aesthetic
  birthHeight: 2.6,
  exitHeight: 46,
  railBirth: -11,
  railExit: 44,
            ...
            Array.from({ length: cards }, (_, i) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    card,
                    "absolute overflow-hidden shadow-md ring-1 ring-black/5",
                  )}
                  style={{
                    left: "50%",
                    top: `${axis}%`,
